...
var VMInfo = module.exports = function (options) {
    ...
    self.startVmWatchers = function (zonename, callback) {
        ...
        if (zonename === undefined) {
            ...
            addVMFsWatches(self.vmobjs[zonename].zonename);
            callback();
        }
    };
    ...
    self.stopVmWatchers = function (zonename, callback) {
        ...
        if (zonename === undefined) {
            ...
            removeVMFsWatches(self.vmobjs[zonename].zonename);
        }
                    ...
                    async.series([
                        ...
                        function (cb1) {
                            ...
                            async.each(keys),
                                ...
                                if (!objs.hasOwnProperty(zonename)) {
                        ...
                        function (cb1) {
                            var old_objs = self.old_vm_data.zoneadm_objects;
                            var keys = Object.keys(old_objs);
                            async.each(Object.keys(keys),
                                function (zonename, cb2) {
                                var new_objs = self.vm_data.zoneadm_objects;
...
// todo: I REALLY need to stop the fswatchers
...
// todo:
// sometimes zone deletes under high concurrency do not run delete code path
//  ^ might have something to do with fswatcher... not sure
// need to find a more optimized way of getting zoneinfo data (~500ms)
// stop fswatchers and zpool watchers on stop
