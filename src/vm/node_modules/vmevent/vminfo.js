 ...
 *  destroy - emitted when an existing vm is deleted
 *
 ...
 *
 * on 'destroy' the callback will be called, passing the zonename of the vmobj
...
var VMInfo = module.exports = function (options) {
    ...
    function refreshVmobj(zonename, callback) {
        ...
        async.waterfall([
            ...
            function (vmobj, cb) {
                var opts = {
                    ignores: ['last_modified']
                };
                var changes = objDiff(self.vmobjs[zonename], vmobj, opts);
                self.vmobjs[zonename] = vmobj;
                cb(null, changes);
            },
            // publish changes
