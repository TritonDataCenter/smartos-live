...
If you're on an older zone image, than 2014.4, you should just create a
...
In this case, we're interested in upgrade the instance called
...
it you will find a single uncomentted line:
