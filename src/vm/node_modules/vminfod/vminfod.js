    ...
    vasync.pipeline({funcs: [
        function (_, cb) {
            ...
            getZoneRecords(zonename, opts, function (err, records) {
                ...
                assert.equal(records.length, 1, 'Not a single record found');
                var rec = records[0];
            ...
            self.zonenameToUuid[zonename] = uuid;
...
Vminfod.prototype.deleteVmobj = function deleteVmobj(zonename, callback) {
    ...
    vasync.pipeline({funcs: [
        ...
        function (_, cb) {
            ...
            delete (self.zonenameToUuuid)[zonename];
