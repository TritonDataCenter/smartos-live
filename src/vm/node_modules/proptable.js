 ...
 *    file or pulled from mdb (see 'zoneinfo'). This means that you must also
 ...
 *  watchers:
 *
 *     Any property of a zone object MUST have this set to at least one vmevent
 *     watcher. This is used by vminfod to ensure any changes to the VM are
 *     loaded asap.
 *
 *
 *  zfs: {fields: [], types: []}
 ...
 *    zone_t property (see '::walk zone | ::print zone_t' | mdb -k) that should
 *    be included in this VM object.
 *
 *
 *  zoneinfo_format: <format>
 *
 *    The <format> is a standard printf format value (that mdb supports) that
 *    indicates how the value should be printed. The default is '%d' if this
 *    is not specified. Note: the result of this printf will be fed through
 *    loadValueTranslator if one is defined.
 *
 *
...
exports.brand_options = {
    'joyent': {
        'features': {
            ...
            'zlogin_console': true,
            'zoneinit': true,
            'zoneroot_image_type': 'zone-dataset'
        }
    }, 'joyent-minimal': {
        'features': {
        ...
        'features': {
            ...
            'write_zone_netfiles': true,
            'zlogin_console': true,
            'zoneroot_image_type': 'lx-dataset'
        }
    }, 'sngl': {
        'features': {
            'cleanup_dataset': true,
