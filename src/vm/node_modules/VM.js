            ...
            if (manifest.hasOwnProperty('requirements')) {
                ...
                if (req.hasOwnProperty('bootrom')) {
                    ...
                    if (VM.BOOTROMS.indexOf(image.bootrom) === -1) {
                        // But we don't allow a path to a bootrom at provision
                        // time since this is guaranteed to failure since
                        // there's no way to get a custom rom into the
                        // filesystem until after the zone is created.
                        e = new Error('invalid bootrom value for image '
                            + image.uuid + ' passed: ' + image.bootrom
