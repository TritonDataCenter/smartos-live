...
var XML_PROPERTIES = {
    ...
    'zone.attr': {
        ...
        'hostname': 'hostname',
        'init-name': 'init_name',
        'maintain-resolvers': 'maintain_resolvers',
...
function loadVM(uuid, data, options, callback)
{
    ...
    getVmobj(info.zonename, data, options, function (err, vmobj) {
        ...
        // Always display firewall_enabled
...
function buildNicZonecfg(vmobj, payload, log)
{
    ...
    // we add all the properties here. primary gets set below
