...
Queue.prototype._checkFastForwarded = function () {
    ...
    for (var id in this.channels) {
        ...
        for (var key in this.channels[id].jobs) {
            if (key < this.stop_at) {
