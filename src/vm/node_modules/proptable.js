...
exports.properties = {
    add_disks: {
        ...
        payload: {
            ...
            type: 'boolean'
            // We will create new VMs with this explicitly true, see
            // VM.js's applyZoneDefaults(). VMs without this present
            // will be set to false, for now (illumos-joyent makes the
            // final call).
        },
...
exports.brand_options = {
    'bhyve': {
        ...
        'features': {
            ...
            'model_required': true,
            'runtime_info': ['all', 'block', 'blockstats', 'chardev', 'console',
                'cpus', 'kvm', 'pci', 'spice', 'status', 'version', 'vnc'],
            'serial_console': true,
            'type': 'KVM',
