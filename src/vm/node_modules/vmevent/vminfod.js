...
{
    console.log('FS: ' + JSON.stringify(obj, null, 2));
    ...
    if (zonexml_re.test(obj.pathname)) {
        ...
        console.log('ZONEXML zonename: ' + zonename);
            ...
            if (obj.type == 'delete') {
                ...
                async.series([
                    ...
                    function (cb) {
                        ...
                        console.log('RESULT: ' + JSON.stringify(vmobjs[zonename], null, 2));
                        cb();
                    },
                    // clean vm_data
                    function (cb) {
                        for (key in vm_data) {
                            if (key[zonename]) {
                                ...
                                delete key[zonename];
                                console.log('RESULT: ' + key[zonename]);
                            }
                        }
                        cb();
                    }
                ...
                contexts.forEach(function (context) {
                    if (vm_data[context] !== undefined && 
                        vm_data[context][zonename]) {

                        var binding = vm_data[context]
                        delete binding[zonename];
                    }
                });
