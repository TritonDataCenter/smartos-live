...
exports.getProvisionableMemory = function (callback)
{
    this.getMemoryInfo(function (err, data) {
        ...
        /*
        console.log('DEBUG:',
            'memory:', Math.floor(data.total_bytes / (1024 * 1024)),
            'arc:', Math.ceil(data.arcsize_bytes / (1024 * 1024)),
            'reserved arc:', Math.ceil(reserve_arc / (1024 * 1024)),
            'reclaimable arc:', Math.floor(reclaimable_arc / (1024 * 1024)));
         */
