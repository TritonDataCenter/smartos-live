...
exports.waitForZoneState = function (payload, state, options, callback)
{
    ...
    vs = new vminfod.VminfodEventStream('VM.js waitForZoneState');
...
function installZone(payload, log, callback)
{
    ...
    async.series([
        function (cb) {
            ...
            log.debug('creating vminfod event stream');
            vs = new vminfod.VminfodEventStream('VM.js installZone zoneadm');
            ...
            vs = new vminfod.VminfodEventStream('VM.js installZone');
            vs.on('ready', cb);
            log.debug('vminfod event stream ready');
        }, function (cb) {
...
function createZone(payload, log, callback)
{
    ...
    log.debug('creating vminfod event stream');
    vs = new vminfod.VminfodEventStream('VM.js createZone');
...
function deleteZone(uuid, log, callback)
{
    ...
    async.series([
        ...
        // TODO: replace these next two with VM.stop(..{force: true} ?
            ...
            log.debug('creating vminfod event stream');
            var vs = new vminfod.VminfodEventStream('VM.js deleteZone');
...
function startZone(vmobj, opts, callback)
{
    ...
    async.series([
        function (cb) {
            ...
            log.debug('creating vminfod event stream');
            vs = new vminfod.VminfodEventStream('VM.js startZone');
...
exports.update = function (uuid, payload, options, callback)
{
    ...
    async.series([
        ...
        function (cb) {
            ...
            log.debug('creating vminfod event stream');
            vs = new vminfod.VminfodEventStream('VM.js update');
...
function halt(uuid, log, callback)
{
    ...
    vasync.pipeline({funcs: [
        function (_, cb) {
            ...
            log.debug('creating vminfod event stream');
            vs = new vminfod.VminfodEventStream('VM.js halt');
