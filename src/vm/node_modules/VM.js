 ...
 *
 */
function buildDockerTtyZonecfg(vmobj, payload, log) {
    var log_driver;
    var new_logmode;
    var new_tty_value;
    var old_logmode;
    ...
    /*
     * Determine what tty mode we want (undefined will mean we aren't trying to
     * set)
     */
    ...
    if (new_tty_value !== undefined) {
        /* we're trying to set *something* here */
    ...
    if (!old_logmode && !new_logmode) {
        // We always want a logmode, so if we're missing it and we don't already
        // have one, set to 'logging' as the default.
        new_logmode = 'logging';
    }
...
function buildZonecfgUpdate(vmobj, payload, log)
{
    ...
    zcfg = zcfg + buildDockerTtyZonecfg(vmobj, payload, log);
