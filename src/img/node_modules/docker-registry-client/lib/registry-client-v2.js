...
/*
 * Get a manifest digest from a MEDIATYPE_MANIFEST_LIST_V2
 * that needs to be used to get the actual manifest object.
 *
 *   client.getManifest({ref: <tag>}, function (err, manifestRef, res)
 *   {
 *   });
 * @param ref: {Object}
 * @param cb {Function} `function (err, manifestRef, res)`
 */
