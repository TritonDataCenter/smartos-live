...
function createVM(payload, log, callback)
{
    ...
    async.series([
        function (cb) {
            ...
            log.info({payload: payload}, 'Checking for cloudinit');
            ...
            if (payload.brand === 'bhyve'
                ...
                payload.add_disks.push({
                    ...
                    boot: false,
                    media: 'disk',
                    block_size: 512, // FAT16 default

                    // This property is used to identify the disk later when
                    // adding the cloudinit YAML files. It's not saved to the
                    // final machine's JSON
...
function installZone(payload, log, callback)
{
    ...
    async.series([
        ...
        }, function _createCloudIinitNoCloudVolume(cb) {
