...
function buildDockerLogZonecfg(vmobj, payload, log) {
    ...
    new_logmode = calculateZlogMode(payload, vmobj);
    ...
    async.series([
        function (cb) {
            ...
            if (vmobj.docker) {
                ...
                var new_zlog_mode = calculateZlogMode(payload, vmobj);
...
function calculateZlogMode(payload, vmobj) {
    var zlog_mode = {
        gz: false,
        tty: false,
        ngz: false
    ...
    return zlogObjToString(zlog_mode);
}
