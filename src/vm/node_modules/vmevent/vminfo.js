            ...
            function (cb) {
                ...
                if (changes.length > 0) {
                    ...
                    async.series([
                        ...
                        function (cb1) {
                            async.each(Object.keys(self.vm_data),
                                function (zonename, cb2) {
                                if (!old_vm_data.hasOwnProperty(zonename)) {
                        ...
                        function (cb1) {
                            async.each(Object.keys(old_vm_data),
                                function (zonename, cb2) {
                                if (!self.vm_data.hasOwnProperty(zonename)) {
