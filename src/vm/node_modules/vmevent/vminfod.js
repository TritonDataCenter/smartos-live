...
function handleZpoolEvent(obj)
{
    ...
    // determine and extract uuid first

    function expire() {
        sections.forEach(function (section) {
            if (vm_data.hasOwnProperty(section) &&
                vm_data[section].hasOwnProperty(name)) {

                delete (vm_data[section])[name];
            }
        });
    }

    function fetch(cb) {
        var opts = {log: log, dataset: obj.dsname};
        getDatasets(opts, cb);
    }
