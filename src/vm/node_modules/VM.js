...
exports.waitForZoneState = function (payload, state, options, callback)
{
    ...
    vasync.pipeline({funcs: [
        function (_, cb) {
            ...
            var opts = {
                ident: sprintf('waiting for zone_state: %s', state),
        ...
        function (cb) {
            ...
            vs.once('ready', function () {
                ...
                vasync.parallel({funcs: [
                    function (cb2) {
                        ...
                        var opts = {
                            ident: 'filesystems during zoneadm install',
                            timeout: VMINFOD_TIMEOUT,
                            catchErrors: true,
                            teardown: true
                        };
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                    ...
                    var opts = {
                        ident: 'setting "indestructible_zoneroot"',
                        timeout: VMINFOD_TIMEOUT,
                        catchErrors: true
                    };
                    cancelFn = vs.watchForEvent(obj, opts, cb2);
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                    var opts = {
                        ident: 'setting ZFS data properties',
                        timeout: VMINFOD_TIMEOUT,
                        catchErrors: true
                    };
                    cancelFn = vs.watchForEvent(obj, opts, cb2);
        ...
        // an instance is fully provisioned.
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                    ...
                    var opts = {
                        ident: 'removing "provisioning" marker',
                        timeout: VMINFOD_TIMEOUT,
                        catchErrors: true
                    };
        ...
        function (_, cb) {
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                    ...
                    var opts = {
                        ident: 'removing "transition_to" marker',
                        timeout: VMINFOD_TIMEOUT,
                        catchErrors: true,
                        teardown: true
                    };
        ...
        function (_, cb) {
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                    ...
                    var opts = {
                        ident: 'adding "transition_to" marker',
                        timeout: VMINFOD_TIMEOUT,
                        catchErrors: true,
                        teardown: true
                    };
        ...
        function (cb) {
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                    ...
                    var opts = {
                        ident: 'coping back existing metadata',
                        timeout: VMINFOD_TIMEOUT,
                        catchErrors: true,
                        startFresh: true
                    };
        ...
        function (cb) {
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                    ...
                    var _opts = {
                        ident: 'zonecfg setting autoboot',
                        timeout: VMINFOD_TIMEOUT,
                        catchErrors: true,
                        startFresh: true
                    };
        ...
        function (cb) {
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                    ...
                    var opts = {
                        ident: 'updating zone last_modified in delete_snapshot',
                        timeout: VMINFOD_TIMEOUT,
                        catchErrors: true,
                        teardown: false
                    };
        ...
        function (cb) {
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                    ...
                    var opts = {
                        ident: 'updating last_modified in create_snapshot',
                        timeout: VMINFOD_TIMEOUT,
                        catchErrors: true,
                        teardown: false
                    };
        ...
        function (_, cb) {
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                    ...
                    var opts = {
                        ident: 'zoneadm halt waiting for zone_state '
                            + '"installed"',
                        timeout: VMINFOD_TIMEOUT,
                        catchErrors: true,
                        teardown: true
        ...
        function (cb) {
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                     ...
                     */
                    var opts = {
                        ident: 'waiting for zone_state "stopped"',
                        timeout: 300 * 1000,
                        catchErrors: true,
                        teardown: false
                    };
