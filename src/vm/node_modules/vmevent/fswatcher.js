...
function FsWatcher(options)
{
    ...
    function handleResponse(obj) {
        ...
        if (obj.result == 'FAIL') {
            ...
            if (self.watches[obj.pathname]
                 ...
                 * watch. We'll try to see if that's the case and if so
                 * re-parent the child to the more accurate parent. If that is
                 * not the case,  there's nothing special to do until it 
                 * gets an event.
                 */
    ...
    self.event_queue = vasync.queue(function (obj, callback) {
    ...
    self.event_queue.drain = function () {
        // log.trace('event_queue is empty');
    };
