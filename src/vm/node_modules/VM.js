        ...
        function (_, cb) {
            ...
            vasync.parallel({funcs: [
                function (cb2) {
                    ...
                    // after we've started the watcher (if we checked before
                    // there'd be a race) we check whether we're already in the
                    // target state, if we are close it down and return.
