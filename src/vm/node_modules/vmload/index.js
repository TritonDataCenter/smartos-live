    ...
    async.series([
        function (cb) {
            ...
            if (cache.zonexml_objects
                ...
                for (key in cache.zonexml_objects[uuid]) {
                ...
                res.on('end', function () {
                   if (res.statusCode === 200) {
                        try {
                            ...
                            cache = {};
                            log.debug('failed to parse body from vminfod: ' + e.message);
                        }
                        cb();
                    } else {
                        log.debug('vminfod response not usable: ' + res.statusCode);
                        cb();
                    }
                });
...
function loadJsonObjects(uuid, cache, options, callback)
{
    ...
    async.each(uuids, function (vm_uuid, cb) {
        ...
        if (uuid !== null) {
            if (cache.json_objects === undefined) {
                cache.json_objects = {};
            }
...
function loadLastExited(uuid, cache, options, callback)
{
    ...
    async.each(uuids, function (vm_uuid, cb) {
        ...
        if (uuid !== null) {
            if (cache.last_exited === undefined) {
                cache.last_exited = {};
            }
...
function loadZoneinfoObjects(uuid, cache, options, callback)
{
    ...
    getZoneinfo(uuid, options, function (err, results) {
        ...
        if (uuid !== null) {
            if (cache.zoneinfo_objects === undefined) {
...
function loadZoneadmObjects(uuid, cache, options, callback)
{
    ...
    getZoneRecords(uuid, options, function (err, results) {
        ...
        if (uuid !== null) {
            if (cache.zoneadm_objects === undefined) {
...
function loadZonexmlObjects(uuid, cache, options, callback)
{
    ...
    async.each(uuids,
        function (vm_uuid, cb) {
            ...
            if (uuid !== null) {
                if (cache.zonexml_objects === undefined) {
