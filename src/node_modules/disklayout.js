...
compute_layout(disks, layout)
{
	...
	if (!layout) {
		if (diskroles.storage.length == 1)
			layout = 'single';
		else if (diskroles.storage.length == 5 ||
		    diskroles.storage.length > 16 ||
		    diskroles.storage.length > 7 &&
		    diskroles.storage[0].size > 1500 * 1000 * 1000 * 1000)
			layout = 'raidz2';
		else if (diskroles.storage.length > 4 &&
		    diskroles.storage.length < 12 &&
