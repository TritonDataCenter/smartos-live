 ...
 */
VminfodEventStream.prototype._transform = function _transform(chunk, encoding, cb) {
...
function watchForEvent(obj, opts, cb) {
    ...
    // if a timeout is specified, the stream should be torn down after
    // a match
    if (opts.timeout) {
        opts.teardown = true;
    }
