 ...
 *    file. This means that you must also have a 'zonexml' value for this
 *    property. When this is set, values will be passed through the specified
 *    function while being loaded. This is used for example to ensure that
 *    values that should be numbers or booleans are converted from strings as
 *    often in zonecfg the only option for type is 'string'.
 *
 *    Example:
 *
