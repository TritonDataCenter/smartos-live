...
function getZoneData(uuid, options, callback)
{
    ...
    async.series([
        ...
        function (cb) {
            ...
            var sockfile = '/var/run/vminfod.sock';

            if (options.hasOwnProperty('vminfo_sock')) {
                sockfile = options.vminfo_sock;
            }

            var opts = {socketPath: sockfile, path: '/cache'};
            // temporary
            // var opts = {host: '127.0.0.1', port: 9090, path: '/cache'};
