    ...
    vs.on('ready', function () {
        ...
        vasync.parallel({funcs: [
            ...
            function (cb2) {
                ...
                writeAndRename(log, 'routes', filename, data, function (err) {
                    if (err) {
                        cancel();
                        cb2(err);
                        return;
    ...
    async.series([
        function (cb) {
            ...
            keys.forEach(function (key) {
                ...
                // TODO: maybe there's a list of these somewhere?
                var IGNORE_KEYS = [
                    'zonename',
                    'uuid',
                    'last_modified',
                ...
                // if we are here, the key being modified is not "special" and
                // we should just watch for it to change to the value specified
                // in the payload
                change = {
                    path: [key],
                    to: value
